...
> Calibrated against 35 pages this project wrote. Separation on them is not evidence about pages nobody here has seen.
...
`adversarial-neutral-decline-kekkou-ja` (6), `adversarial-neutral-decline-plan-ja` (6) — labelled clean, and scored on findings that should not exist. The arithmetic is right and the input is wrong, which is a precision problem and not a scoring one.
...
| `adversarial-neutral-decline-kekkou-ja` | negative | 6 | medium |
| `adversarial-neutral-decline-no-i-en` | negative | 0 | low |
| `adversarial-neutral-decline-plan-ja` | negative | 6 | medium |
