...
> Calibrated against 57 pages — 51 this project wrote and 6 it did not. Separation on them is not evidence about pages nobody here has seen.
...
| Measure | Value |
| --- | --- |
| Pages with a labelled problem | 25 |
| …of those, detected by the rules | 25 |
...
| `adversarial-neutral-decline-kekkou-ja` | negative | 0 | low |
...
| `clean-modal-with-icon-close-en` | negative | 0 | low |
| `clean-modal-with-later-ja` | negative | 0 | low |
...
| `consent-bundled-terms-and-marketing-ja` | positive | 6 | medium |
| `consent-pre-checked-marketing-en` | positive | 20 | high |
| `consent-pre-checked-marketing-ja` | positive | 20 | high |
| `consent-pre-checked-marketing-valued-attribute-en` | positive | 20 | high |
| `hidden-cost-checkout-price-only-en` | positive | 6 | medium |
| `hidden-cost-checkout-price-only-ja` | positive | 6 | medium |
...
| `obstruction-modal-without-close-ja` | positive | 3 | medium |
| `scarcity-countdown-timer-en` | positive | 2 | low |
| `scarcity-countdown-timer-ja` | positive | 8 | medium |
| `scarcity-phrase-stock-pressure-en` | positive | 3 | medium |
| `scarcity-phrase-stock-pressure-ja` | positive | 3 | medium |
| `subscription-cta-dont-miss-out-en` | positive | 9 | medium |
| `subscription-cta-miss-nothing-ja` | positive | 6 | medium |
