...
export const BEHAVIOUR_PROBE_CASES = Object.freeze([
  ...
  "clean-modal-with-icon-close-en",
  "clean-modal-with-later-ja",
  "clean-neutral-decline-en",
  "clean-separate-consent-checkboxes-en",
  "clean-stock-status-en",
  "clean-subscribe-cta-with-cancellation-en",
  "clean-terms-and-privacy-one-checkbox-en",
  ...
  "subscription-free-trial-no-renewal-ja",
]);
