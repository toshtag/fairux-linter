 ...
 * capped at "medium". Applied centrally here, not inside rules. See the JSX/TSX adapter contract
 * (`docs/architecture/decisions/jsx-tsx-adapter-contract.md`), "Confidence ceiling for AST findings".
 */
