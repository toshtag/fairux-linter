...
type _Remediation = Assert<Equal<Core.Remediation, Public.Remediation>>;
type _TextEdit = Assert<Equal<Core.TextEdit, Public.TextEdit>>;
type _Finding = Assert<Equal<Core.Finding, Public.Finding>>;
