/**
 * The browser half of the v1 registry consumer contract: the published DOM entry point, bundled
 * for the browser platform and executed against a browser-like document. Uses only surface
 * `@fairux/sdk@0.1.0-beta.2` already publishes; new surface is proven by a future v2 directory,
